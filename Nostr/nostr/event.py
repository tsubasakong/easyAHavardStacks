...
class Event:
    ...
    # temp adapt to room kind 42
    def add_event_ref(self, event_id:str, ws_ref:str, maker:str):
        """ Adds a reference to an event_id as an 'e' tag """
        self.tags.append(['e', event_id, ws_ref, maker])
    
    def add_ws_ref(self, url:str):
        """ Adds a reference to an relay url """
        self.tags.append([url])
    
    def add_marker_ref(self, marker:str):
        """ Adds a reference to an event_id as an 'e' tag """
    ...
    def to_message(self) -> str:
        ...
        print("event.py to_message", send_content)
